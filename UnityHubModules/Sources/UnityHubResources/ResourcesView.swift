...
public struct ResourcesView: View {
	...
	public var body: some View {
		VStack {
			Link("Manual", destination: URL(string: "https://docs.unity3d.com/Manual/index.html")!)
			Link("Scripting Reference", destination: URL(string: "https://docs.unity3d.com/ScriptReference/index.html")!)
