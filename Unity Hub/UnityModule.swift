...
extension UnityModule: RawRepresentable {
    ...
    var rawValue: (String, String, AnyView) {
        switch self {
        case .macOSMono: return ("macOS", "mac-mono", AnyView(SVGShapes.macOS().frame(width: 20, height: 20)))
        case .macOSIL2CPP: return ("macOS", "mac-il2cpp", AnyView(SVGShapes.macOS().frame(width: 20, height: 20)))
        case .windowsMono: return ("Windows", "windows-mono", AnyView(SVGShapes.Windows().frame(width: 20, height: 20)))
        case .windowsIL2CPP: return ("Windows", "windows-il2cpp", AnyView(SVGShapes.Windows().frame(width: 20, height: 20)))
        case .linuxMono: return ("Linux", "linux-mono", AnyView(SVGShapes.Linux().frame(width: 20, height: 20)))
        case .linuxIL2CPP: return ("Linux", "linux-il2cpp", AnyView(SVGShapes.Linux().frame(width: 20, height: 20)))
